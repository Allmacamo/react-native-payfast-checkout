export const generateMD5 = (s: string) => {
  ...
  function u(G: number, F: number, aa: number, Z: number, k: any, H: number, I: number) {
    G = K(G, K(K(r(F, aa, Z), k), I))
    return K(L(G, H), F)
  }
  function f(G: number, F: number, aa: number, Z: number, k: any, H: number, I: number) {
    G = K(G, K(K(q(F, aa, Z), k), I))
    return K(L(G, H), F)
  }
  function D(G: number, F: number, aa: number, Z: number, k: any, H: number, I: number) {
    G = K(G, K(K(p(F, aa, Z), k), I))
    return K(L(G, H), F)
  }
  function t(G: number, F: number, aa: number, Z: number, k: any, H: number, I: number) {
